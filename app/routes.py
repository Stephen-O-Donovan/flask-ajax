# handles the different URLs of the app
from app import main
from app.forms import LoginForm
from config import *

from flask import render_template, flash, redirect, url_for, request, json # Several tools that will be needed
...
@main.route('/')
@main.route('/index') # root and index will both go to index page
